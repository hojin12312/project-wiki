...
4. Preserve local policy exactly: `wiki-language`, the budgets, hosts, and protected blocks, header comments, local categories, and every local rule that is stricter or additional. Changing any of them is a separate proposal.
